function process_pol_testData(basePath, selectedSampleType, verifyMatches) % Parses and categorizes polarization data files based on the given file names, optionally displaying matched file info
