function [DoLP_POL, AoLP_POL] = load_pol_analysis(method, datasetName)  % process POL data according to selected method ( 'Standard', '2nd Order Fourier', '4th Order Fourier')
