function process_hs_testData(baseDir, verifyDatasetSeparation) % Parses and categorizes hyperspectral data folders into structured datasets based on the given foulder names, optionally displaying parsed groups info
