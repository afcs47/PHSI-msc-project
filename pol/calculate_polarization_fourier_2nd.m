function [DoLP, AoLP] = calculate_polarization_fourier_2nd(polar_images) % outputs DoLP, AoLP, computed from 2nd order Fourier model from the inputed polar_images demosaiced polarization stack
