function tform = calibrateHsiPolData(fpath, fname_selected, pol_raw_path, datasetname, check_calibration) %Aligns and fuses HSI and Polarization images via checkerboard homography
